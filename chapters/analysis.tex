...
For this benchmark, the function \texttt{sd\_update} has the highest potential for alias misses; as the name suggests, this function updates the binary matrix used to represent the sudoku puzzle. Figure \ref{sdc} shows the C implementation of this function.

\lstinputlisting[language=C] {figures/sd\_update.c}
