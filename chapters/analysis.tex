...
\lstinputlisting[language=C, numbers=left] {figures/sd\_update.c}
...
\lstinputlisting[firstline=758, lastline=776, numbers=left] {figures/sudoku\_v1.ll}
...
\lstinputlisting[firstline=233, lastline=251, numbers=left] {figures/matmul\_v1.ll}
...
\lstinputlisting[language=C, firstline=20, lastline=36, numbers=left] {figures/dict\_v1.c}
...
\lstinputlisting[firstline=140, lastline=157, numbers=left] {figures/dict\_v1.ll}
...
\lstinputlisting[firstline=301, lastline=329, numbers=left] {figures/dict\_v1.ll}
