; ModuleID = 'sudoku_v1.c'
source_filename = "sudoku_v1.c"
...
define %struct.sdaux_t* @sd_genmat() #0 {
  ...
  %10 = call i8* @calloc(i64 1, i64 11664)
...
; <label>:5:                                      ; preds = %17, %16, %0
  %6 = getelementptr inbounds [1024 x i8], [1024 x i8]* %3, i32 0, i32 0
  %7 = call %struct._reent* @__getreent()
  %8 = getelementptr inbounds %struct._reent, %struct._reent* %7, i32 0, i32 1
  %9 = load %struct.__sFILE64*, %struct.__sFILE64** %8, align 8
  %10 = call i8* @fgets(i8* %6, i32 1024, %struct.__sFILE64* %9)
...
; <label>:17:                                     ; preds = %12
  %18 = load %struct.sdaux_t*, %struct.sdaux_t** %2, align 8
  %19 = getelementptr inbounds [1024 x i8], [1024 x i8]* %3, i32 0, i32 0
  %20 = call i32 @sd_solve(%struct.sdaux_t* %18, i8* %19)
  %21 = call i32 @putchar(i32 10)
  br label %5

; <label>:22:                                     ; preds = %5
  %23 = load %struct.sdaux_t*, %struct.sdaux_t** %2, align 8
  %24 = bitcast %struct.sdaux_t* %23 to i8*
